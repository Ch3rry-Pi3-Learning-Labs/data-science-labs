...
def build_template() -> None:
    cells = [
        ...
        **CH3RRY PI3 Data Science Learning Labs**
        ...
        [One friendly paragraph explaining the problem, why it matters and what the reader will build.]
        ...
        **Last reviewed:** [Date]
        ...
        """),
        markdown(heading("problem", 2, "2. Problem and intuition") + "\n\nBegin with the practical question. Explain what is known, what must be learned and why the proposed method helps."),
...
Equation (3.1) can be read as: average the observation-level loss $\ell_i$ over all $N$ observations to obtain the overall objective $J$.
"""),
        ...
        markdown(heading("worked-example", 2, "5. Hand-worked example") + "\n\nState the starting values, substitute them into the equation, show the important arithmetic and interpret the result."),
        ...
        markdown(heading("summary", 2, "9. Summary and next steps") + "\n\nSummarise the method, connect the mathematics to the code and suggest one purposeful extension."),
    ]
